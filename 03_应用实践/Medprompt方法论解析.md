...
- **提示词工程系统教程**:本笔记是「高级提示词工程」的具体实战案例,系统的入门到进阶请走 [02_提示词工程/](../02_提示词工程/README.md) 子项目
- **动态 few-shot 的底层就是 RAG**:动态少样本检索的实现思路(embedding + kNN)与 [RAG/RAG学习笔记.md](RAG/RAG学习笔记.md) 完全一致——只不过 RAG 检索的是"知识文档",Medprompt 检索的是"示例题目"
- **"不微调"路线 vs "微调"路线的对照**:Medprompt 是"通用模型 + 复杂提示"路线的代表,与之对照的"训练专用模型"路线见 [模型训练技术速查.md](../00_核心概念/模型训练技术速查.md)(SFT / 蒸馏 / RFT 等)
- **医学场景的工程落地案例**:Medprompt 在医学测试上超过专用模型 Med-PaLM 2,与之配套的真实业务场景案例见 [宠物 CT 影像 AI 辅助诊断方案.md](宠物CT影像AI辅助诊断方案.md)(也用了"多模态大模型 + RAG"的思路)
- **20 次集成的成本估算**:Medprompt 一道题调用 20 次 API,成本计算 / fallback 设计参见 [LLM-API 选型方法论.md](LLM-API选型方法论.md)(5 维度框架里的"价格"维度)
