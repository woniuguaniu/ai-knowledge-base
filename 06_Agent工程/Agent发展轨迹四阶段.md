...
> 📌 **本节讲的是"职业定义 + 造词批判"**。如果你想要的是另一面——**该掌握哪些能力、按什么顺序学**——见姊妹篇 [Agent 架构师能力地图与学习路线](Agent架构师能力地图与学习路线.md)（含 8 大能力域地图 + 6 个能力边界学习阶段 + Claude × Codex 双模型评分）。
...
| 维度 | 客观情况 |
|---|---|
| 时效性 | 含约 18 处具体版本号/型号表述；文件最后修改于 2026-08-29——版本与价格类信息变动快，引用前请核对当前情况 |
