...
- 涉及账户操作的指令必须经过用户明确确认（[HITL](#46-人在回路hitl)）
...
- 正文引用的外部域名：`attacker.com`、`evil.com`
...
| 维度 | 客观情况 |
|---|---|
| 时效性 | 含约 44 处具体版本号/型号表述；文件最后修改于 2026-06-04——版本与价格类信息变动快，引用前请核对当前情况 |
| 覆盖范围 | 全文约 27k 字，覆盖范围以正文目录为准，未展开的边界情况请另行查证 |
