...
>
> **适用时间**：截至 2026-05-29 的知识库整理版本。Claude Code 的命令、flag、模型名和权限机制变化很快，实际使用前建议先跑 `/help`、`/status` 或查看当前官方文档。
...
- 正文引用的外部域名：`open.bigmodel.cn`、`bigmodel.cn`、`api.moonshot.cn`、`platform.moonshot.cn`、`dashscope.aliyuncs.com`
...
| 维度 | 客观情况 |
|---|---|
| 时效性 | 含约 24 处具体版本号/型号表述；含约 2 处价格相关表述；文件最后修改于 2026-06-04——版本与价格类信息变动快，引用前请核对当前情况 |
| 覆盖范围 | 全文约 9k 字，覆盖范围以正文目录为准，未展开的边界情况请另行查证 |
