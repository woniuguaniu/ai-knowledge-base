...
- [软件工程产品研发 SOP](软件工程产品研发SOP.md) —— 从需求进入、产品 Spec、架构设计、实施计划、TDD、质量门禁到上线反馈的完整研发流水线；本文对应其中的"阶段 3：技术选型与架构设计"
...
- 参考资料：软件工程产品研发 SOP 软件工程产品研发SOP.md —— 从需求进入、产品 Spec、架构设计、实施计划、TDD、质量门禁到上线反馈的完整研发流水线；本文对应其中的"阶段 3：技术选型与架构设计"
- 参考资料：《系统架构设计师教程》
- 参考资料：《大型网站技术架构》- 李智慧
- 参考资料：《微服务设计》- Sam Newman
- 参考资料：《高性能MySQL》- Baron Schwartz
...
| 维度 | 客观情况 |
|---|---|
| 时效性 | 含约 24 处具体版本号/型号表述；文件最后修改于 2026-05-28——版本与价格类信息变动快，引用前请核对当前情况 |
