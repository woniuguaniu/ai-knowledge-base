...
#### 挂载宿主机文件夹到容器（持久化数据）
```bash
docker run -v /Users/xxddd/data:/app/data my-image
```
| 参数 | 含义 |
|---|---|
| `-v 宿主路径:容器路径` | 把电脑的 `/Users/xxddd/data` 文件夹挂载到容器内的 `/app/data` |
...
```bash
ln /Users/xxddd/photo.jpg /Users/xxddd/Desktop/相册.jpg
```
