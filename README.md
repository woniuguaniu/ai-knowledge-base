...
| **Apifox** ⭐新增 | [Apifox.md](05_技术基础/Apifox.md) | **国产 API 全生命周期管理工具**：Postman + Swagger + Mock + JMeter 四合一；核心功能（接口文档 / 调试 / Mock 服务 / 自动化测试 / 代码生成）+ 环境变量管理 + 团队协作最佳实践 + 从 Postman 迁移指南 + 5 大常见误区（不写文档 / Mock 数据不符合业务逻辑 / 接口改了不更新文档等）+ 与前后端分离架构的关系 |
