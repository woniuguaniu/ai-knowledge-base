...
| **图像生成** | Image Generation | 根据文字/草图生成新图 | 新图片（Stable Diffusion 类，提示词写法见 [AI绘画提示词的基本结构](../07_文生图与文生视频/AI绘画提示词的基本结构.md)） |
...
- 正文引用的外部域名：`pypi.tuna.tsinghua.edu.cn`
...
| 维度 | 客观情况 |
|---|---|
| 时效性 | 含约 3 处具体版本号/型号表述；文件最后修改于 2026-08-29 |
| 覆盖范围 | 全文约 15k 字，覆盖范围以正文目录为准，未展开的边界情况请另行查证 |
